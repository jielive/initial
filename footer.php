...
<div class="container">
<div class="row">
<p>&copy; <?php echo date('Y'); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a>.<?php _e('由 <a href="http://www.typecho.org">Typecho</a> 强力驱动'); ?>.<?php _e('使用 <a href="https://www.offodd.com/17.html">Initial</a> 主题'); ?>.</p>
